...
class Textfield extends Component {
  ...
  set bufferedValue(v) {
    ...
    if (v && !this._previousValue) {
      this._aniFloatLabel();
    }
    this._previousValue = this._bufferedValue;
  }
  ...
  showHeaderIfNotEmpty() {
    if (this.props.defaultValue && !this._previousValue) {
      this._aniDefaultHighlight();
    }
  }

  // animation when textfield focused
  _aniDefaultHighlight() {
